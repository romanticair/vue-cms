  ...
  export default {
    data() {
      return {
        ...
        goodsinfo:{ //获取到的商品的信息
          title:'测试品',market_price:999,sell_price:600,stock_quantity:66,goods_no:6,add_time:'2009-1-8'
        },
    ...
    methods: {
      ...
      getGoodsInfo() {
        this.$http.get("api/goods/getinfo/" + this.id).then(result => {
          if (result.body.status === 0) {
            // return {title:*,market_price:*,sell_price:*,stock_quantity:*,goods_no:*,add_time:*}
